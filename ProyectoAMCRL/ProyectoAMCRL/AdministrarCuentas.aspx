        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <asp:GridView class="table table-hover table-bordered table-striped" ID="gridCuentas" runat="server" AllowSorting="True" AllowPaging="True"  PageSize="5" AutoGenerateSelectButton="True" OnPageIndexChanging="gridCuentas_PageIndexChanging" OnSelectedIndexChanging="gridCuentas_SelectedIndexChanging" OnSorting="gridCuentas_Sorting">
