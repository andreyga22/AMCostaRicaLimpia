    ...
    <div class="container">
        ...
        <div class="justify-content-center">
            ...
            <div class="form-group">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Display="Dynamic" ErrorMessage="Máxima cantidad de letras permitida es: 10" ForeColor="Red" ValidationGroup="bodegaG" ValidationExpression="^[a-zA-Z0-9\s]{1,10}$"  ControlToValidate="codigoTb"></asp:RegularExpressionValidator>
...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" Display="Dynamic" ErrorMessage="Máxima cantidad de letras permitida es: 50" ForeColor="Red" ValidationGroup="bodegaG" ValidationExpression="^[a-zA-Z0-9\s]{1,50}$" ControlToValidate="nombreTB"></asp:RegularExpressionValidator>
...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" Display="Dynamic" ErrorMessage="Máxima cantidad de letras permitida es: 15" ForeColor="Red" ValidationGroup="bodegaG" ValidationExpression="^[a-zA-Z\s]{1,15}$" ControlToValidate="provinciaTb"></asp:RegularExpressionValidator>
...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" Display="Dynamic" ErrorMessage="Máxima cantidad de letras permitida es: 15" ForeColor="Red" ValidationGroup="bodegaG" ValidationExpression="^[a-zA-Z\s]{1,15}$" ControlToValidate="cantonTb"></asp:RegularExpressionValidator>
...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" Display="Dynamic" ErrorMessage="Máxima cantidad de letras permitida es: 15" ForeColor="Red" ValidationGroup="bodegaG" ValidationExpression="^[a-zA-Z\s]{1,15}$" ControlToValidate="distritoTb"></asp:RegularExpressionValidator>
...
&nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" Display="Dynamic" ErrorMessage="Máxima cantidad de letras permitida es: 200" ForeColor="Red" ValidationGroup="bodegaG" ValidationExpression="^[a-zA-Z0-9\s]{1,200}$" ControlToValidate="otrasTb"></asp:RegularExpressionValidator>
