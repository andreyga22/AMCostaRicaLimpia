    ...
    public partial class AdministrarMonedas : System.Web.UI.Page {
        ...
        private DataTable buscar() {
            ...
            if(datat.Rows.Count == 0) {
                lblError.Text = "<div class=\"alert alert-danger alert - dismissible fade show\" role=\"alert\"> <strong></strong> No hay monedas registradas en este momento.<button type = \"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"> <span aria-hidden=\"true\">&times;</span> </button> </div>";
