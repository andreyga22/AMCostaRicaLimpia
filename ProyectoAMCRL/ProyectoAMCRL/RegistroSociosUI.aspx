...
<asp:Content ID="Content4" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="container">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-sm-5" id="estado" runat="server" visible="true">
        ...
        <%-- SUBMMIT BUTTON --%>
        <div class="row justify-content-center">
            <asp:Button ID="btnRegistrar" type="submit" runat="server" Text="Guardar" class="btn btn-info" OnClick="btnRegistrar_Click" ValidationGroup="socioG" />
        </div>
