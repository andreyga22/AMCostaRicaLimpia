    ...
    <div class="container">
        ...
        <div class="form-row justify-content-center">
            <div class="form-group col-sm-6">
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" Display="Dynamic" ErrorMessage="Máxima cantidad de letras permitida es: 50" ForeColor="Red" ValidationGroup="unidadG" ValidationExpression="^.{1,50}$" ControlToValidate="codigoTb"></asp:RegularExpressionValidator>
        ...
        <div class="form-row justify-content-center">
            <div class="form-group col-sm-6">
                ...
                &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" Display="Dynamic" ErrorMessage="Máxima cantidad de letras permitida es: 50" ForeColor="Red" ValidationGroup="unidadG" ValidationExpression="^.{1,50}$" ControlToValidate="estadoRb"></asp:RegularExpressionValidator>
