    ...
    <div class="container">
        ...
        <div class="form-row justify-content-center">
            <div class="form-group col-md-6">
                ...
                &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" Display="Dynamic" ErrorMessage="Formato incorrecto, sólo se permiten números y coma. (Tamaño max: 12)" ForeColor="Red" ValidationGroup="unidadG" ValidationExpression="^(?=[0-9,]{1,12}$)[0-9]+(,[0-9]+)*$" ControlToValidate="equivalenciaTb"></asp:RegularExpressionValidator>
