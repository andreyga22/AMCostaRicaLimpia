...
namespace ProyectoAMCRL
{
    public partial class GestionDeInventario : System.Web.UI.Page
    {
        ...
        private DataTable buscar()
        {
            ...
            {
                BLManejadorInventario manejador = new BLManejadorInventario();
                return manejador.buscarStock(bodDD.SelectedItem.Text);
            }
            catch (Exception)
            {
                return null;
        ...
        protected void bodDD_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                if ((txtPalabra.Text.Trim()).Equals("") || txtPalabra.Text.Trim() == null)
                {
                    gridInventario.DataSource = this.buscar();
                    gridInventario.DataBind();
                }
                else
                {
        ...
        protected void buscarFiltrado()
        {
            try
            {
                BLManejadorInventario manejador = new BLManejadorInventario();
                gridInventario.DataSource = manejador.buscarFiltrado(bodDD.SelectedItem.Text, txtPalabra.Text.Trim());
                gridInventario.DataBind();
            }
            catch (Exception)
            {
