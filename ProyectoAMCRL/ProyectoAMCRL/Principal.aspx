...
<asp:Content ID="Content3" ContentPlaceHolderID="breadcrumbBodyHolder" runat="server">
                ...
                <div class="col-sm-5 offset-1">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <asp:DropDownList class="btn btn-info dropdown-toggle" type="dropdown" ata-toggle="dropdown" aria-haspopup="true" aria-expanded="false" AutoPostBack="True" ID="sociosDrop" runat="server">
                ...
                <div class="col-sm-5 offset-1">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <asp:DropDownList class="btn btn-info dropdown-toggle" type="dropdown" ata-toggle="dropdown" aria-haspopup="true" aria-expanded="false" AutoPostBack="True" ID="compraVentaDrop" runat="server">
                ...
                <div class="col-sm-5 offset-1">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <asp:DropDownList class="btn btn-info dropdown-toggle" type="dropdown" ata-toggle="dropdown" aria-haspopup="true" aria-expanded="false" AutoPostBack="True" ID="inventarioDrop" runat="server">
                ...
                <div class="col-sm-5 offset-1">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <asp:DropDownList class="btn btn-info dropdown-toggle" type="dropdown" ata-toggle="dropdown" aria-haspopup="true" aria-expanded="false" AutoPostBack="True" ID="facturasDrop" runat="server">
                ...
                <div class="col-sm-5 offset-1">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <asp:DropDownList class="btn btn-info dropdown-toggle" type="dropdown" ata-toggle="dropdown" aria-haspopup="true" aria-expanded="false" AutoPostBack="True" ID="reportesDrop" runat="server">
                ...
                <div class="col-sm-5 offset-1">
                    <div class="card" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <asp:DropDownList class="btn btn-info dropdown-toggle" type="dropdown" ata-toggle="dropdown" aria-haspopup="true" aria-expanded="false" AutoPostBack="True" ID="DropDownList1" runat="server">
